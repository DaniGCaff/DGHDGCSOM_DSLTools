...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	/// </summary>
	internal partial class DGH_DGC_SOM_IKPDocData : DGH_DGC_SOM_IKPDocDataBase
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPDocData.
		/// </summary>
		public DGH_DGC_SOM_IKPDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a DGH_DGC_SOM_IKP document in memory.
	/// </summary>
	internal abstract partial class DGH_DGC_SOM_IKPDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPDocDataBase.
		/// </summary>
		protected DGH_DGC_SOM_IKPDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::CE.DGH_DGC_SOM_IKP.AplicacionIPK modelRoot = null;
			...
			global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::CE.DGH_DGC_SOM_IKP.AplicacionIPK modelRoot = (global::CE.DGH_DGC_SOM_IKP.AplicacionIPK)this.RootElement;
			...
			{
				global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDiagram diagram = diagrams[0] as global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::CE.DGH_DGC_SOM_IKP.AplicacionIPK modelRoot = this.RootElement as global::CE.DGH_DGC_SOM_IKP.AplicacionIPK;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
