...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	/// </summary>
	internal partial class DGH_DGC_SOM_IKPCommandSet : DGH_DGC_SOM_IKPCommandSetBase
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPCommandSet.
		/// </summary>
		public DGH_DGC_SOM_IKPCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DGH_DGC_SOM_IKPCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPCommandSetBase.
		/// </summary>
		protected DGH_DGC_SOM_IKPCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDGH_DGC_SOM_IKPExplorerCommand,
				typeof(DGH_DGC_SOM_IKPEditorFactory).GUID);
		...
		{
			DGH_DGC_SOM_IKPExplorerToolWindow explorer = this.DGH_DGC_SOM_IKPExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DGH_DGC_SOM_IKPDocData CurrentDGH_DGC_SOM_IKPDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DGH_DGC_SOM_IKPDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DGH_DGC_SOM_IKPDocView CurrentDGH_DGC_SOM_IKPDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DGH_DGC_SOM_IKPDocView;
			}
		}
		...
		/// </summary>
		protected DGH_DGC_SOM_IKPExplorerToolWindow DGH_DGC_SOM_IKPExplorerToolWindow
		{
			get
			{
				DGH_DGC_SOM_IKPExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DGH_DGC_SOM_IKPExplorerToolWindow), true) as DGH_DGC_SOM_IKPExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DGH_DGC_SOM_IKPExplorerToolWindow explorerWindow = this.DGH_DGC_SOM_IKPExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DGH_DGC_SOM_IKPClipboardCommandSet : DGH_DGC_SOM_IKPClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPClipboardCommandSet.
		/// </summary>
		public DGH_DGC_SOM_IKPClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DGH_DGC_SOM_IKPClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPClipboardCommandSetBase.
		/// </summary>
		protected DGH_DGC_SOM_IKPClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
