...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	/// </summary>
	internal partial class DGH_DGC_SOM_IKPDocView : DGH_DGC_SOM_IKPDocViewBase
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPDocView.
		/// </summary>
		public DGH_DGC_SOM_IKPDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DGH_DGC_SOM_IKPDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPDocView.
		/// </summary>
		protected DGH_DGC_SOM_IKPDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DGH_DGC_SOM_IKPDocDataBase docData = this.DocData as DGH_DGC_SOM_IKPDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DGH_DGC_SOM_IKPDocViewBase should be an DGH_DGC_SOM_IKPDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DGH_DGC_SOM_IKPDiagramMenu;
			}
		}
			...
			if(global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::CE.DGH_DGC_SOM_IKP.DGH_DGC_SOM_IKPHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
