...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	/// </remarks>
	public partial class DGH_DGC_SOM_IKPHelpKeywordHelper : DGH_DGC_SOM_IKPHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPHelpKeywordHelper.
		/// </summary>
		protected DGH_DGC_SOM_IKPHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DGH_DGC_SOM_IKPHelpKeywordHelper.
		/// </summary>
		public static DGH_DGC_SOM_IKPHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DGH_DGC_SOM_IKPHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DGH_DGC_SOM_IKPHelpKeywordHelperBase.
		/// </summary>
		protected DGH_DGC_SOM_IKPHelpKeywordHelperBase()
			: base() { }
