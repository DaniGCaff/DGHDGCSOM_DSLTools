...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	partial class DGH_DGC_SOM_IKPDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			DGH_DGC_SOM_IKPSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing DGH_DGC_SOM_IKP models.
	/// </summary>
	public abstract partial class DGH_DGC_SOM_IKPSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected DGH_DGC_SOM_IKPSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(DGH_DGC_SOM_IKPDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new DGH_DGC_SOM_IKPSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(DGH_DGC_SOM_IKPDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(DGH_DGC_SOM_IKPSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing DGH_DGC_SOM_IKP models.
	/// </summary>
	public sealed partial class DGH_DGC_SOM_IKPSerializationHelper : DGH_DGC_SOM_IKPSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private DGH_DGC_SOM_IKPSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static DGH_DGC_SOM_IKPSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static DGH_DGC_SOM_IKPSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (DGH_DGC_SOM_IKPSerializationHelper.instance == null)
					DGH_DGC_SOM_IKPSerializationHelper.instance = new DGH_DGC_SOM_IKPSerializationHelper();
				return DGH_DGC_SOM_IKPSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	partial class DGH_DGC_SOM_IKPSerializationHelperBase
	{
	
		/// <summary>
		/// Loads a AplicacionIPK instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new AplicacionIPK instance will be created into the default partition of this store.</param>
		/// <param name="fileName">Name of the file from which the AplicacionIPK instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded AplicacionIPK instance.</returns>
		public virtual AplicacionIPK LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a AplicacionIPK instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded AplicacionIPK instance.</returns>
		public virtual AplicacionIPK LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a AplicacionIPK instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new AplicacionIPK instance will be created.</param>
		/// <param name="fileName">Name of the file from which the AplicacionIPK instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual AplicacionIPK LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			AplicacionIPK modelRoot = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(partition.Store);
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(AplicacionIPK.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for AplicacionIPK!");
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = DGH_DGC_SOM_IKPSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as AplicacionIPK;
		...
		/// <param name="modelRoot">AplicacionIPK instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the AplicacionIPK instance will be saved.</param>
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="modelRoot">AplicacionIPK instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the AplicacionIPK instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the AplicacionIPK instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the AplicacionIPK instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized AplicacionIPK instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			...
			global::System.Xml.XmlWriterSettings settings = DGH_DGC_SOM_IKPSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">DGH_DGC_SOM_IKPDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the diagram.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized DGH_DGC_SOM_IKPDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = DGH_DGC_SOM_IKPSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		/// <summary>
		/// Helper method to create and initialize a new AplicacionIPK.
		/// </summary>
		internal protected virtual AplicacionIPK CreateModelHelper(DslModeling::Partition modelPartition)
		{
			AplicacionIPK model = new AplicacionIPK(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a AplicacionIPK instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new AplicacionIPK instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the AplicacionIPK instance will be deserialized.</param>
		/// <param name="diagramFileName">Name of the file from which the DGH_DGC_SOM_IKPDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		/// </param>
		...
		/// </param>
		/// <returns>The loaded AplicacionIPK instance.</returns>
		public virtual AplicacionIPK LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
		...
		/// <summary>
		/// Loads a AplicacionIPK instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new AplicacionIPK instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the AplicacionIPK instance will be deserialized.</param>
		...
		/// <summary>
		/// Loads a AplicacionIPK instance and its associated diagram file.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="modelPartition">Partition in which the new AplicacionIPK instance will be created.</param>
		/// <param name="modelFileName">Name of the file from which the AplicacionIPK instance will be deserialized.</param>
		/// <param name="diagramPartition">Partition in which the new DGH_DGC_SOM_IKPDiagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the DGH_DGC_SOM_IKPDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual AplicacionIPK LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			DGH_DGC_SOM_IKPDiagram diagram = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(diagramPartition.Store);
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(DGH_DGC_SOM_IKPDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for DGH_DGC_SOM_IKPDiagram");
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as DGH_DGC_SOM_IKPDiagram;
										if (diagram != null)
										{
		...
		/// <summary>
		/// Helper method to create and initialize a new DGH_DGC_SOM_IKPDiagram.
		/// </summary>
		...
		internal protected virtual DGH_DGC_SOM_IKPDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			DGH_DGC_SOM_IKPDiagram diagram = new DGH_DGC_SOM_IKPDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">DGH_DGC_SOM_IKPDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string modelFileName, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string modelFileName, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given AplicacionIPK and DGH_DGC_SOM_IKPDiagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">AplicacionIPK instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, AplicacionIPK modelRoot, string modelFileName, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">DGH_DGC_SOM_IKPDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given DGH_DGC_SOM_IKPDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">DGH_DGC_SOM_IKPDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, DGH_DGC_SOM_IKPDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/DGH_DGC_SOM_IKP";
			}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						DGH_DGC_SOM_IKPSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					DGH_DGC_SOM_IKPSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				DGH_DGC_SOM_IKPSerializationBehaviorSchemaValidationCallback validationCallback = new DGH_DGC_SOM_IKPSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					DGH_DGC_SOM_IKPSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			DGH_DGC_SOM_IKPSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class DGH_DGC_SOM_IKPSerializationBehaviorSchemaValidationCallback
		{
			...
			internal DGH_DGC_SOM_IKPSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					DGH_DGC_SOM_IKPSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::CE.DGH_DGC_SOM_IKP.AplicacionIPK modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace CE.DGH_DGC_SOM_IKP
{
	...
	public partial class AplicacionIPK
	{
		/// <summary>
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = DGH_DGC_SOM_IKPSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									DGH_DGC_SOM_IKPDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
